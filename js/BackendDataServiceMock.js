            ...
            function(resolve, reject) {
                window.setTimeout(
                    function() {
                        ...
                        var returnMe = [
                            [user + " display name", "Free Time", new Date(year, month, day, 7,30,0,0), new Date(year, month, day, 8,0,0,0)],
                            [user + " display name", "Free Time", new Date(year, month, day, 9,0,0,0), new Date(year, month, day, 9,30,0,0)],
                            [user + " display name", "Free Time", new Date(year, month, day, 13,30,0,0), new Date(year, month, day, 14,0,0,0)]
                        ];
                        resolve(returnMe);
                    }, Math.random() * 2000 + 1000);
            });
